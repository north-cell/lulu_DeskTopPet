...
from .games.flappy_lulu import FlappyLuluWindow
from .games.greedy_lulu import GreedyLuluWindow
from .games.lulu_2048 import Lulu2048Window
...
class PetWindow(QWidget):
    def __init__(
        ...
        self._active_game_window: FlappyLuluWindow | GreedyLuluWindow | Lulu2048Window | WhackLuluWindow | None = None
    ...
    def add_games_menu(self, menu: QMenu) -> QMenu:
        ...
        games_menu.addAction("2048噜", self.start_lulu_2048_game)
        games_menu.addAction("Flappy Lulu", self.start_flappy_lulu_game)
